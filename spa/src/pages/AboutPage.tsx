          ...
          <div className="md:col-span-2 text-gray-200/95 leading-relaxed" ref={textRef}>
            <div className="markdown">
              ...
              <div className="flex flex-row flex-wrap gap-4 mb-4">
                ...
                <a href="https://www.instagram.com/eru_narayana?igsh=MTd5dGwwbDhidGFxdA==" role="button" target="_blank" rel="noopener noreferrer" className="glass text-md trajan-text nv-glass--inner-hairline border border-white/10 rounded-lg px-3 py-2 inline-block !text-white !hover:text-gray-200 text-center !no-underline">Arman's Instagram</a>
              </div>
